...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<h1 id="fh5co-logo"><a href="/main">Marble</a></h1>
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					<li class="fh5co-active"><a href="/main">Home</a></li>
				   			...
				   			<div class="row">
					   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					...
					   					<h2>Data Room Made by <a href="http://freehtml5.co/" target="_blank">Team Naruto</a></h2>
											<p><a class="btn btn-primary btn-demo popup-vimeo" href="/member/login"> <i class="icon-monitor"></i>Login</a> <a class="btn btn-primary btn-learn" href="/member/join">Join<i class="icon-arrow-right3"></i></a></p>
					   				</div>
					   			</div>
					   		</div>
				   		</div>
